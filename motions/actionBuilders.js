...
const ACTION_BUILDERS = {
  ...
  scroll_top: createActionBuilder("scroll_top", () => ({ type: INTENTS.SCROLL_TOP })),
  scroll_bottom: createActionBuilder("scroll_bottom", () => ({ type: INTENTS.SCROLL_BOTTOM })),
  nav_back: createActionBuilder("nav_back", () => ({ type: INTENTS.NAV_BACK })),
  nav_forward: createActionBuilder("nav_forward", () => ({ type: INTENTS.NAV_FORWARD })),
  reload_page: createActionBuilder("reload_page", () => ({ type: INTENTS.RELOAD_PAGE })),
  ...
  new_buffer: createActionBuilder("new_buffer", () => ({ type: INTENTS.NEW_BUFFER })),
  split_vertical: createActionBuilder("split_vertical", () => ({ type: INTENTS.SPLIT_VERTICAL })),
  ...
  page_down: createActionBuilder("page_down", () => ({ type: INTENTS.PAGE_DOWN })),
  ...
  split_close_right: createActionBuilder("split_close_right", () => ({ type: INTENTS.SPLIT_CLOSE_RIGHT })),
  split_devtools: createActionBuilder("split_devtools", () => ({ type: INTENTS.SPLIT_DEVTOOLS })),
};
